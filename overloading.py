...
class Apartemen(Rumah):
    ...
    def fasilitas(self, *fasilitas_tambahan):  
        fasilitas_utama = "Apartemen ini memiliki kolam renang dan gym."
        if fasilitas_tambahan:
            fasilitas_utama += " Fasilitas tambahan: " + ", ".join(fasilitas_tambahan) + "."
        print(fasilitas_utama)
...
class Villa(Rumah):
    ...
    def fasilitas(self, *fasilitas_tambahan):  
        fasilitas_utama = "Villa ini memiliki taman pribadi dan area BBQ."
        if fasilitas_tambahan:
            fasilitas_utama += " Fasilitas tambahan: " + ", ".join(fasilitas_tambahan) + "."
        print(fasilitas_utama)
...
apartemen_jakarta.fasilitas("Parkir bawah tanah", "Kafe")  
...
villa_bali.display()
villa_bali.bentuk()
villa_bali.fasilitas("Kolam renang pribadi", "Area bermain anak")  
